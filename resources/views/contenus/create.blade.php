    ...
    <div class="container mt-5">
        <div class="card shadow-sm" style="max-width: 700px; margin:auto;">
            <div class="card-header bg-primary text-white d-flex align-items-center">
                <i class="bi bi-journal-text me-2"></i> Créer un contenu
            </div>
            ...
            <div class="card-body">
                <form action="{{ route('contenus.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="titre" class="form-control @error('titre') is-invalid @enderror"
                                   placeholder="Titre du contenu" value="{{ old('titre') }}" required>
                            @error('titre') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <!-- Texte -->
                        <div class="col-12">
                            <label class="form-label fw-bold"><i class="bi bi-pencil-square me-1"></i> Texte</label>
                            <textarea name="texte" rows="3" class="form-control @error('texte') is-invalid @enderror"
                                      placeholder="Votre texte...">{{ old('texte') }}</textarea>
                    ...
                    <div class="mt-4 text-end">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="bi bi-check-circle-fill"></i> Enregistrer</button>
                    </div>
                </form>
            </div>
        </div>
